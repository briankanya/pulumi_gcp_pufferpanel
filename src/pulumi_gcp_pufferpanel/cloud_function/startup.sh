...
apt -y install adoptopenjdk-8-hotspot adoptopenjdk-11-hotspot adoptopenjdk-16-hotspot apt-transport-https ca-certificates curl gnupg lsb-release pufferpanel screen wget
apt -y upgrade
